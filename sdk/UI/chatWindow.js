        ...
        var returnFun = (function ($, KRPerfectScrollbar) {
            ...
            window.onresize = function (event) {
                ...
                if (($('.kore-chat-window').width() > 480) || (document.getElementsByClassName('kore-chat-window').length && document.getElementsByClassName('kore-chat-window')[0].classList.contains('expanded'))) {
                    ...
                    $('.carousel').attr('style', 'width: 300px');
                }
            ...
            chatWindow.prototype.renderMessage = function (msgData) {
                ...
                const date = new Date(msgData.createdOn);
            ...
            chatWindow.prototype.getChatTemplate = function (tempType) {
                ...
                <div id="maininputbox" style="width:100%;display:flex;">\
                ...
                {{if isSpeechEnabled}}\
                <div class="sdkFooterIcon microphoneBtn" style="padding-top:17px;margin-right:10px"> \
                ...
                {{/if}} \
        </div><div style="text-align:center;font-size:10px;font-weight:400;border-radius: 0 0 10px 10px !important;background:black;padding:10px"> Powered by <img style="width:50px" src="./assets/img/logo1.png"> </div>';
